...
class MyApplication(npyscreen.NPSAppManaged):
   def onStart(self):
       self.addForm('MAIN', myEmployeeForm, name='New Employee', lines=25, columns=60, minimum_lines=10, minimum_columns=20)
       self.addForm('MAIN2', myEmployeeForm, name='New2 Employee')
