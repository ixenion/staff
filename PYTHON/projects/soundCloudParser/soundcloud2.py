...
url = 'https://api-v2.soundcloud.com//users/297511850/followers?offset=1626960938052&limit=5&client_id=QFciLWLC1GS4P3EZvXIjA3jKhKO5pKB3&app_version=1626941202&app_locale=en'
...
def parse():
    ...
    if scode == 200:
        ...
        print('---> Positions tot:', len(json_data))
        extract = []
        for i in range(0, len(json_data)):
            extract.append(json_data[i]['title'])
