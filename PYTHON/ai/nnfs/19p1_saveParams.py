...
model1.set(loss=Loss_CategoricalCrossentropy(),optimizer=Optimizer_Adam(learning_rate=0.001, decay=5e-6), accuracy=Accuracy_Categorical())

# finalize the model
model1.finalize()

# train model
model1.train(X, y, epochs=1, batch_size=128, print_every=100, validation_data=(X_test, y_test))

# retrieve and print params
parameters = model1.get_parameters()
model1.save_parameters('fashion_mnist.params')'''
# new model
model = Model()
# add layers
