...
dense1 = Layer_Dense(2,512, weight_regularizer_l2=5e-4, bias_regularizer_l2=5e-4)# 2 inputs because each sample has 2 features, 3 outputs

# create ReLU activation
activation1 = Activation_ReLU()

# create dropout layer
dropout1 = Layer_Dropout(0.0)# from 0.0 to 1.0   0.1 means 10% dropout
