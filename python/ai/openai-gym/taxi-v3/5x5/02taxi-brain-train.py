...
gamma = 0.6 # discount factor (0 <= gamma <= 1). Determines how much importance we wand to give to future revards.
# A high value for the discount factor (close to 1) captures the long-term effective award,
# whereas, a discount factor of 0 makes our agent consider only immediate reward.
epsilon = 0.1 # the higher epsilon the more agent explores space and not exploiting learned values 
