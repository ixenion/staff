...
X_test, y_test = create_spiral_data(100,2)

# reshape albels to e a list of listss
...
# for non categorical
model.set(loss=Loss_BinaryCrossentropy(),optimizer=Optimizer_Adam(learning_rate=0.005, decay=5e-8), accuracy=Accuracy_Categorical())

# finalize the model
model.finalize()

# train model
model.train(X, y, epochs=4000, print_every=100, validation_data=(X_test, y_test))
