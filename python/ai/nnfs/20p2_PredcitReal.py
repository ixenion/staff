...
class Model:
    ...
    def predict(self, X, *, batch_size=None):
        # default walue if batch size is not being set
        prediction_steps = 1
        # alculate number of steps
        if batch_size is not None:
...
'''# image preprocessing
image_data = cv2.imread('etc/data/fashion/tshirt.png', cv2.IMREAD_UNCHANGED)
...
image_data = cv2.imread('etc/data/fashion/tshirt.png', cv2.IMREAD_GRAYSCALE)
import matplotlib.pyplot as plt
...
# image_data = cv2.imread('etc/data/fashion/tshirt.png', cv2.IMREAD_GRAYSCALE)
# pants
image_data = cv2.imread('etc/data/fashion/pants.png', cv2.IMREAD_GRAYSCALE)
...
model = Model.load('saves/fashion_mnist_10epoch_1hidden128N.model')

# evaluate the model
print ('predicting...')
confidences = model.predict(image_data)
predictions = model.output_layer_activation.predictions(confidences)
#tuple(fashion_mnist_labels)
