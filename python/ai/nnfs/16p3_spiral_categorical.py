...
import time
# create dataset
X, y = create_spiral_data(300,3)
X_test, y_test = create_spiral_data(100,3)
...
model.set(loss=Loss_CategoricalCrossentropy(),optimizer=Optimizer_Adam(learning_rate=0.05, decay=5e-6), accuracy=Accuracy_Categorical())
