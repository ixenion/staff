...
model.set(loss=Loss_CategoricalCrossentropy(),optimizer=Optimizer_Adam(learning_rate=0.001, decay=1e-5), accuracy=Accuracy_Categorical())

# finalize the model
model.finalize()

# train model
model.train(X, y, epochs=1, batch_size=128, print_every=50, validation_data=(X_test, y_test))
print ('evaluating:')
