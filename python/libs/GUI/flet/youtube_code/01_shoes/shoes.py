...
class App(UserControl):
    ...
    def MainContainer(self):
        ...
        # SEVEN: The image
        # The image starts with the black color, but this can be changed as needed
        self.img = Container(
            scale=Scale(1.1),
            content=Image(
...
if __name__ == "__main__":
    ...
    # flet.app(target=start, view=flet.WEB_BROWSER, assets_dir="assets")
